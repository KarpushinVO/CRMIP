...
class ProxyModel:
    ...
    def make_initial_conditions(self):
        ...
        automatic_initial_qliq0 = list(self.qliq0.keys()) #Нужно задать правильную размерность для массива
    ...
    def crm_calculate(self, q_input, tau_input, f_input): #TODO: Нужно донастроить функциюю по аргументам, в циклах используются атрибуты класса, а нужно аргументы прим.: тау f
        ...
        # TODO: сделать проверку на совпадение длин на входящие данные в аргументы функции
        for i, j in enumerate(self.prod_CRM): # TODO: обернуть в функцию, чтобы было красиво + можно обойтись без енумерейт
...
if __name__ == "__main__":
    ...
    print((model1.crm_calculate(
        q_input = list(model1.qliq0.values()),
        tau_input = list(model1.tau.values()),
        f_input=list(model1.f.values())
    )))
